...
export async function POST(
  ...
  if (!application.rulePackId) {
    return Response.json({ error: "No rule pack pinned to this application" }, { status: 400 });
  }
  ...
  return Response.json({
    ...
    rulePack: { id: rulePack.id, version: rulePack.version, verificationLevel: rulePack.verificationLevel },
  });
}
